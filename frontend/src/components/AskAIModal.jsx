      ...
      <div className="jira-modal-container" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 680, height: 600 }}>
        ...
        <div className="jira-modal-body" style={{ flex: 1, padding: "16px 20px" }}>
          ...
          <div className="jira-ai-quick-prompts">
            <button
              className="jira-ai-prompt-chip"
              onClick={() => handleSend("Summarize project backlog & health")}
            >
              📊 Summarize backlog
            </button>
            <button
              className="jira-ai-prompt-chip"
              onClick={() => handleSend("Identify potential sprint blockers")}
            >
              ⚠️ Find blockers & risks
            </button>
            <button
              className="jira-ai-prompt-chip"
              onClick={() => handleSend("Generate a user story for data science pipeline")}
            >
              💡 Generate user story
            </button>
          </div>
          ...
          <div className="jira-ai-chat-thread">
            ...
            {loading && (
              <div className="jira-ai-msg-bubble ai">
                <div className="jira-ai-msg-avatar">✨</div>
                <div className="jira-ai-msg-text">
