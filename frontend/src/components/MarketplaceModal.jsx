  ...
  const [apps, setApps] = useState([
    {
      ...
      desc: "Connect branches, commits, pull requests, and deployment statuses directly to Jira tickets.",
      icon: "🐙",
      connected: true,
      downloads: "1.2M",
    },
    {
      ...
      desc: "Receive instant updates when issues are created, assigned, or updated in dedicated team channels.",
      icon: "💬",
      connected: true,
      downloads: "2.4M",
    },
    {
      ...
      name: "Figma for Jira",
      category: "Design",
      desc: "Embed live Figma files, design specs, and prototypes directly inside Jira issue cards.",
      icon: "🎨",
      connected: false,
      downloads: "850K",
    },
    {
      id: "ai_copilot",
      name: "Atlassian Intelligence AI",
      category: "AI & Productivity",
      desc: "Generate issue summaries, write acceptance criteria, and translate customer requests into user stories.",
      icon: "✨",
      connected: true,
      downloads: "500K",
    },
    {
      ...
      category: "Monitoring",
      desc: "Automatically create Jira bugs from unhandled frontend and backend exceptions.",
      icon: "🛡️",
      connected: false,
      downloads: "420K",
    },
            ...
            {apps.map((app) => (
              <div key={app.id} className="jira-marketplace-card">
                <div className="jira-app-card-top">
                  <div className="jira-app-icon">{app.icon}</div>
                  <div>
